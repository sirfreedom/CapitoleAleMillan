...
namespace WebApi.Entity
{
    public abstract class EntityBase
    {
        ...
        public static string DataTableToString(DataTable dt, string Condicion, string Campo, string ValorDefault = "")
        {
        ...
        public static string DataTableToString(DataTable dt, string Campo, string ValorDefault = "")
        {
            string s = ValorDefault;
            try
            {
        ...
        public static DataTable DataTableToDataTableFiltrado(DataTable dt, string Condicion)
        {
        ...
        public static DataSet JsonToDatatable(string Json)
        {
        ...
        /// </param>
        /// <returns></returns>
        public Dictionary<string, string> PropertiesToDictionary(bool IncludeBlankSpace = false, bool IncludeZero = false)
        {
                ...
                if (initProperty.CanRead)
                {
                    ...
                    foreach (PropertyInfo finalProperty in finalProperties)
                    {
                        if (finalProperty.Name == initProperty.Name && finalProperty.CanWrite)
                        {
                            ...
                            {
                                StringBuilder sb = new StringBuilder();
                                sb.Append((((System.DateOnly)value)).Year.ToString());
                                sb.Append((((System.DateOnly)value)).Month.ToString());
                                sb.Append((((System.DateOnly)value).Day.ToString()));
